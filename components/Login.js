...
export default function Login(props) {
  ...
  return (
    ...
    <TextInput 
    style={{fontSize:20,borderColor:'black',borderWidth:2,width:150}}
    onChangeText={(text)=>setEmail(text)}
    ></TextInput>
    <Button title='Login' onPress={() => props.navigation.navigate('Home',{name,age,email})} /> */}
      ...
      <View style={styles.gotoReg}>
        <Text style={{ color: colors.secondary, textAlign: 'center', fontFamily: fonts.Light }}>Don't have a account?</Text>
        <TouchableOpacity>
          <Text style={{ fontSize: 15, marginStart: 2, fontFamily: fonts.semiBold }} onPress={() => navigation.navigate('Register')}>Sign-up</Text>
