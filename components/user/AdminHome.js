  ...
  return (
    <Tab.Navigator
      ...
      <Tab.Screen name='AddUser' component={AddUser}  options={{
        tabBarIcon:({focused})=>
          <View style={styles.tabView}>
            <AntDesign name={'adduser'} color={focused?colors.primary:colors.secondary} size={20}/>
            <Text style={[styles.tabText,{color:focused?colors.primary:colors.secondary}]}>User</Text>
          </View>
